...
(function(){
  ...
  function CONTROLLER(){
    ...
    stl.textContent = ""
      ...
      // translucent-white chip so it stays visible ON the blue bar; hover fills orange (accent).
      ...
      + "#bm-tour-launch:hover{background:#EE4E24;color:#fff;border-color:#EE4E24}";
    ...
    {nav:"Methodology", el:function(){return q(['.bm-engine-wide','.bm-fm']);}, title:"The pipeline",
     desc:"Inputs (prices, cost &amp; macro signals) → the forecasting model (market inputs, AI engine, forecast) → outputs (12-week path, direction, back-checked accuracy)."},
