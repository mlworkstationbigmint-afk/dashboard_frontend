...
REBAR = {
    ...
    "drivers": [
        ("Iron Ore Fines (NMDC, Fe64)",   4850.0,  0.086247, "INR/t"),
        ("Scrap HMS 80:20 (Mumbai)",     33328.0,  0.194529, "INR/t"),
        ("Pellet Fe63 (Raipur)",          9156.25, -0.001238, "INR/t"),
        ("Pig Iron (Raipur)",            37438.0,  0.365247, "INR/t"),
        ("Sponge Iron (Durgapur)",       26192.0, -0.113405, "INR/t"),
        ("Billet (Mumbai)",              41518.0,  0.018898, "INR/t"),
        ("Ingot (Mumbai)",               40994.0,  0.178468, "INR/t"),
...
HR_PLATE = {
    ...
    "drivers": [
        ("Iron Ore Fines Fe62 (CNF Rizhao)",  9519.73, -0.048313, "INR/t"),
        ("Coking Coal HCC MV (FOB Australia)", 21079.67, 0.016004, "INR/t"),
        ("Scrap HMS 80:20 (Mumbai)",          33328.0,  0.023178, "INR/t"),
        ("Pellet Fe63 (Raipur)",               9156.25, 0.026843, "INR/t"),
        ("HRC Exw-Mumbai (IS2062, 2.5-8mm)",  58275.0,  0.731840, "INR/t"),
        ("HRC FOB Rizhao China",              51217.92, 0.083817, "INR/t"),
        ("HRC FOB Black Sea",                 53580.37, 0.079965, "INR/t"),
    ],
}
