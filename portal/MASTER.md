...
## Changelog
### 2026-07-18 (latest+++++++++++++++++++++++++++++++++) — Price Sensitivity: white preset buttons + per-product estimation equation
- [calc_elasticity.py](portal/calculators/calc_elasticity.py) knob-card **preset chips** (−20/−10/0/+10/+20) → solid **white bg + orange (`--bm-accent`) border + primary-dark text**, hover inverts to orange fill/white text (matches the −/+ stepper). Fixes them reading as faint/invisible on the pale card.
