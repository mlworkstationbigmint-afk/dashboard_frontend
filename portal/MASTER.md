...
- **Coverage**: 1W = all 11 products (134/131 wks); 4W = 79 wks, 8W = 75, 12W = 71 — the latter three only carry the **6 Mumbai/Raipur products**, so Mundra + those horizons shows the "No N-week-ahead accuracy data" warning.
