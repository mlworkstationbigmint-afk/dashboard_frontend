...
- **Per-role forecasting layout (adani_dev, 2026-07-07):** beyond branding/access, a role can get a
  ...
  **right-aligned location/full-name dropdown** (styled border + tint, **shared across Graphical+Tabular** so it works
  ...
  one `.bm-vcards` HTML flex column pinned to the 632px chart height, the 3 cards grown into
  equal-height panels with 14px gaps + centred content (own markup — Streamlit-container CSS
  attempts kept bunching);
