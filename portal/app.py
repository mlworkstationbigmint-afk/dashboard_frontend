...
RATIONALES = {
    ...
    "HRC Mundra": (
        ...
        "<b>Net</b> &mdash; Up ₹1,500 over 12 weeks. Cost and mill discipline carry the call; arriving import "
        "cargo is what narrows the west-coast premium."
    ),
    "HR Plate Mundra": (
    ...
    "Rebar BF Mundra": (
        ...
        "<b>Pulling down</b> &mdash; Delivered Kutch, BF sits ₹5,800/t over IF against ₹7,138/t in Mumbai, so "
        "the switch to induction material is a shorter step here than on the west coast. The late-horizon slide "
        "assumes coal relief and diverted capacity returning.<br>"
    ...
    "Rebar IF Mundra": (
        ...
        "<b>Holding up</b> &mdash; Kutch has no induction capacity, so every tonne is railed in from Mumbai "
        "and central India and freight sets the delivered floor. Above that, metallics repriced hard in August: "
        "Raipur sponge +11.9% to ₹26,813/t (spot "
        "₹29,700/t, a two-year high), Mumbai HMS +5.7% to ₹33,533/t, billet and ingot both up ~5%. Imported "
        ...
        "22,000 t a session earlier), and at ₹53,225/t delivered, IF sits ₹5,800/t under BF Mundra against "
        "₹7,138/t in Mumbai &mdash; the cheap-alternative argument is weaker here than on the west coast.<br>"
        "<b>Net</b> &mdash; Flat, then a 4.6% give-back. The delivered premium widens if road and rail "
        "costs rise."
    ),
    "Structure Mundra": (
